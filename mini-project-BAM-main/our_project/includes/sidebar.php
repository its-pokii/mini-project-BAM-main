<aside class="flex flex-col justify-between shadow-[1px_1px_0px] shadow-gray-300 font-semibold text-[1em] text-gray-500 w-[20%] h-[800px]">
    <div class="shadow-[1px_1px_0px] shadow-gray-300 h-full">
        <div class="h-[40%] p-8 flex flex-col justify-between">
            <div class="hover:text-primary flex gap-2 items-center">
                <i class="mr-2 text-md fa-solid fa-house"></i>
